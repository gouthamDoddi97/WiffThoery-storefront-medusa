...
>
> **Operating constraint:** All products are clone-oil fragrances marketed as originals. The storefront IS the brand. Every pixel must justify the positioning: *story-led luxury fragrance house with a simple scent wardrobe.*
...
| Level | Tagline | Usage |
|---|---|---|
| **Primary** | *"Every fragrance, a chapter."* | Website hero, about page, YouTube intros, WhatsApp header, any single-sentence context |
| **Secondary A** | *"Wear the story."* | Instagram bio, packaging tagline, label backs, short-format contexts, favicon hover text |
| **Secondary B** | *"Build your scent wardrobe."* | Product photography captions, display shots, lifestyle content headers, collection banners |
| **Brand Promise** | *"Each perfume carries a character, a mood, and a reason to exist."* | About page, brand story section, email footer |
| **Pricing** | *"Pricing should feel premium, restrained, and intentional."* | Internal only — guides pricing display decisions |

### 1B. Color Palette

Derived from a bright-luxury palette — warm ivory, champagne gold, soft sky, and muted sage. Not Arabian gold. Not Parisian blush. Not white-label sterile.

| Role | Color | Hex | Usage |
|---|---|---|---|
| **Primary Light** | Warm Ivory | `#FBF7F0` | Backgrounds, hero sections, product page base, nav bar |
| **Primary Accent** | Champagne Gold | `#C5A86A` | CTAs, active states, journey progression indicators, links |
| **Secondary Accent** | Sky Blue | `#A9C8E8` | Highlight badges ("New"), hover states, notification dots |
| **Warm Accent** | Sage | `#B8C7B0` | Stars/ratings, premium collection indicators, subtle highlights |
| **Neutral Light** | Porcelain | `#FFFFFF` | Body text backgrounds, card surfaces, product detail areas |
| **Neutral Mid** | Sand | `#B5A89A` | Secondary text, borders, subtle dividers |
| **Text Primary** | Ink | `#1C1A17` | Body text on light backgrounds |
| **Text on Accent** | Warm Ivory | `#FBF7F0` | Text on colored buttons, hero copy |

#### Palette Rules
- **Light mode is the default.** Product pages, hero sections, and collection pages use `#FBF7F0` and `#FFFFFF` backgrounds. The light canvas makes the bottles feel fresh, premium, and easy to browse.
- **Light surfaces for reading.** Product descriptions, about page body text, FAQ — anywhere there's a wall of text, use `#F4EFE7` background.
- **Never use pure black (`#000`) or pure white (`#FFF`).** Always warm. The palette should feel composed, not stark.
- **Gold is the guidance color.** Use it for progression indicators, "next chapter" links, collection navigation breadcrumbs.

### 1C. Typography

| Role | Font | Weight | Usage |
|---|---|---|---|
| **Display / Headings** | **Cormorant Garamond** | SemiBold (600), Bold (700) | Hero headlines, collection names, product names, section titles |
| **Body** | **Inter** | Regular (400), Medium (500) | Product descriptions, about page, all paragraph text |
| **Accent / Taglines** | **Cormorant Garamond** | Medium (500), Italic | Taglines, pull quotes, testimonials, "story behind" narrative |
| **Micro / Labels** | **Inter** | Medium (500), All Caps | Note tags, badges ("SIGNATURE"), price labels, nav items |

#### Typography Rules
- **Headlines are short.** Max 6–8 words. The brand should feel composed, never overwrought.
- **Body text is 16px minimum** on desktop, 15px on mobile. Readability is still non-negotiable.
- **Letter-spacing on ALL CAPS micro text:** +0.05em–0.08em. Keeps labels clean.
- **No script/cursive fonts.** This is quiet luxury, not decoration.

### 1D. Imagery & Visual Direction

| Element | Direction | What to Avoid |
|---|---|---|
| **Product photography** | Dark, elegant backgrounds, controlled lighting, bottle as an object of desire. Think private gallery, not catalog. | Flat white-background product shots. Generic "bottle floating in space." |
| **Label art** | Refined graphic illustrations — each fragrance has a character, scene, or mood. High contrast, but restrained and premium. | Plain text labels, white labels, generic floral/abstract patterns, Arabian filigree. |
| **Lifestyle** | The bottle in context: on a vanity, beside a book, on a lacquer tray, in a travel case. The product is a *personal luxury object.* | Model shoots with perfume held to neck. "Spraying into the air" stock photography. |
| **Flat-lays** | Curated compositions: bottle + paper, stone, fabric, and one or two objects that imply taste. | Cluttered, random objects. Overly styled "influencer" flat-lays. |
| **Backgrounds & Textures** | Stone, lacquer, smoked glass, ivory paper, velvet, brushed metal. Quiet, tactile, premium. | Concrete, raw plywood, rose gold overload, soft pink velvet. |

### 1E. Logo & Mark

| Element | Direction |
|---|---|
| **Wordmark** | "WHIFF THEORY" in a refined serif wordmark, letterspaced. Clean, minimal, no flourishes. Should work at 20px and 200px. |
| **Mark / Icon** | A reduced monogram or seal-like symbol that can sit quietly on a bottle, label, or favicon. Must work as a favicon, app icon, and label stamp. |
...
```
HOME
├── COLLECTIONS (scent wardrobe navigation)
│   ├── Everyday Scents
│   ├── Signature
│   └── Artistic
...
**Purpose:** First impression. Story-first hook. Establish the brand as a luxury house with character-driven perfumes. Show the wardrobe. Get the first click.

#### Sections (top to bottom)

| # | Section | Content | Design Notes |
|---|---|---|---|
| **1** | **Hero** | Full-bleed bright background with a curated carousel of 3 selected perfumes. Primary tagline: *"Every fragrance, a chapter."* One CTA: "Begin the Story" (scrolls to collections or links to Regular). Each slide highlights a different perfume with bottle image, label detail, and one-line character note. | This is the 0.5-second hook. Keep the carousel restrained and editorial, not busy. Slow transitions, minimal controls, and no more than a few handpicked perfumes. |
| **2** | **The Wardrobe Strip** | Horizontal scroll / visual progression showing the 3 collection tiers: Regular → Signature → Bold. Each tier is a card with its mood and level of depth becoming more pronounced as you move right. | This IS the brand differentiator on the homepage. The wardrobe is visible, not buried. Visual escalation left-to-right. |
| **3** | **Featured Products** | 3–4 products displayed as art objects. Large label close-ups. Minimal text — product name, one-line character note, price. Hover/tap reveals "View" CTA. | Not a product grid. A curated gallery. Each product gets breathing room. Light background, products lit like editorial pieces. |
| **4** | **"Why This Is Different" Strip** | 3-column icon strip. (1) "Each fragrance, a chapter" — book icon. (2) "Made to be worn" — bottle icon. (3) "A wardrobe, not a dump" — progression icon. One line each, no paragraphs. | Trust-building without a wall of text. Visual, scannable, confident. Reinforces story and simplicity. |
| **5** | **Social Proof / Shelfie** | Customer photos or styled "shelfie" shots showing bottles displayed in real spaces. If no UGC yet, use branded lifestyle shots of bottles in context (vanity, tray, travel case). Pull quote from a real customer DM if available. | "Fragrance designed to be shown off" — proven. If no real UGC exists yet, use 2–3 curated lifestyle shots with the caption: *"Where does your Whiff Theory live?"* |
...
- Hero: Primary tagline — *"Every fragrance, a chapter."* Hero format: curated carousel of selected perfumes.
- Wardrobe strip heading: *"Start anywhere. Build your story."*
- Social proof section: *"Made to be worn."*
...
| # | Section | Content | Design Notes |
|---|---|---|---|
| **1** | **Collection Hero** | Collection name + descriptor. E.g., "REGULAR — Easy, polished, close to the skin." Light background, collection-specific accent color, representative label art. | Each collection has a slightly different color accent to signal progression. Regular = luminous/clean. Signature = balanced and personal. Bold = more intense and expressive. |
| **2** | **Journey Breadcrumb** | A subtle horizontal indicator showing where this collection sits in the 3-tier wardrobe. The current collection is highlighted. Others are clickable. | Always visible. Always reminds the customer: there's more. The wardrobe is the architecture, not just the product. |
...
| **4** | **"Ready for More?"** | At the bottom: a gentle nudge to the next collection. "Liked Regular? Signature is where it gets more personal." Link/card to next collection. | This is the Collection Ladder in action. Every collection page pushes toward the next. The wardrobe never dead-ends. |

#### Collection-Specific Copy

| Collection | Hero Headline | Descriptor |
|---|---|---|
| **Regular** | "Start Here." | "Easy to wear, polished, and close enough to the skin to feel intimate." |
| **Signature** | "Make It Yours." | "Balanced, memorable, and polished. The scent people begin to associate with you." |
| **Bold** | "Make an Entrance." | "Deeper, darker, and more expressive. For those who want presence and point of view." |
...
| # | Section | Content | Design Notes |
|---|---|---|---|
| **1** | **Product Hero** | Full-width bottle image + label detail. Product name large. Collection badge (e.g., "SIGNATURE"). Price — clean, honest, no crossed-out MRP. | Light background. The bottle and label should be shot in detail — you should be able to see material, texture, and finish. This is the object of desire. |
| **2** | **Scent Profile — Plain Language** | 3–4 sentence mood description. NO note pyramids, no jargon. Describe the *feeling*, not the chemistry. E.g., "Petalina smells like stepping into a garden at sunset — soft rose, a little warmth, the kind of thing that makes someone lean in." | Written in refined editorial voice. Short sentences. Evocative. This is where the story begins. |
| **3** | **The Story Behind** | 2–3 paragraphs of narrative — the mood, the inspiration, the character this scent embodies. Each product has its own chapter. | Styled differently from the scent profile — larger text, pull-quote treatment, slightly different background shade. This is the magazine editorial section. |
| **4** | **Notes & Details (Expandable)** | Collapsible accordion: Top/Middle/Base notes (described in plain language + proper note names), Size (ml), Concentration (EDP), Longevity estimate, Season / Occasion suggestion. | Beginners ignore this. Explorers and collectors open it. It's there for credibility without cluttering the main experience. Keep note descriptions human: "Bergamot (bright, citrusy)" not just "Bergamot." |
| **5** | **The Object** | A dedicated section showing the bottle, label, and finish in detail — the intent, the material feel, the visual story. "Every Whiff Theory bottle is designed to feel like a keepsake." | This section makes the object a feature, not packaging. It is what separates a ₹249 Whiff Theory from a generic clone. |
| **6** | **Add to Cart** | Sticky/fixed CTA on mobile. Clean button: "Add to Cart — ₹249." Price always visible. No fake urgency ("only 3 left!"), no countdown timers. | Premium pricing presentation in action. The button is confident, not desperate. Color: Antique Gold accent. |
| **7** | **"Next Chapter"** | One product recommendation from the next collection up. Not a grid of "you may also like" — a single, confident pointer. "Enjoyed Petalina? Your next chapter is Passion." | This IS the Collection Ladder on the product page. One recommendation. One direction. "Start anywhere, build your story" made tangible. |
...
- "The Story Behind" section: *"Every fragrance, a chapter."*
- "Next Chapter" section: *"There is always a next chapter waiting."*
...
| # | Section | Content | Design Notes |
|---|---|---|---|
| **1** | **Hero** | *"Every fragrance, a chapter."* + a visual of the founder or the Vizag coastline (Bay of Bengal, RK Beach, industrial skyline). | If no founder photo, use a styled Vizag coastal shot. The origin is felt, not forced. "Born on India's eastern coast" lives here. |
| **2** | **The Brand Story** | 3–4 paragraphs. Not a corporate bio — a personal narrative. Why this exists. The "I couldn't find a brand I was proud to name" origin. The story-led luxury mission. The wardrobe architecture. Written in refined editorial voice. | First-person or close to it. This page should read like a conversation, not a press release. "We started because..." not "Whiff Theory was founded in..." |
| **3** | **What We Believe** | The 3 core values presented visually: (1) Story is non-negotiable, (2) Respect the beginner, (3) Built with restraint. Each with a one-line explanation. | Cards or icon-led blocks. Not a bulleted list — each value gets visual weight. These are design objects, not footnotes. |
| **4** | **Vizag Section** | A subtle nod to the city. "Where the Bay of Bengal meets iron and sunrise." A few lines about what Vizag brings to the brand — clarity, contrast, and coastal calm. A coastal photo or illustration. | This is the Easter egg from the positioning strategy — Cultural Identity as an *undercurrent*. Present but not leading. Discovered by those who look. Never heavy-handed. |
| **5** | **The Pricing Note** | A short block: "Our prices are positioned to reflect the full experience — scent, story, and presentation. We keep the presentation restrained and the offering selective." | Reinforces the premium positioning without making price the story. Competitive differentiation through restraint, not comparison. |
| **6** | **CTA** | "Begin the story" → links to Day or the Wardrobe Strip. | Every page pushes toward the product. The About page is never a dead end. |
...
|---|---|---|
| "How long does the fragrance last?" | Honest — "4–8 hours depending on skin type and weather. Apply on pulse points for best results." No over-promising. | #4 — This is real luxury |
| "Which chapter should I start with?" | "If you're new to fragrance: Regular (easy, polished, ₹249) or Signature (personal, refined, ₹799). If you already know your taste: go straight to Bold." | #2 — Start anywhere, build your story |
| "Is this an EDP?" | "Yes. All Whiff Theory fragrances are Eau de Parfum — higher concentration than body sprays or EDT, which means better longevity and projection. In plain English: it lasts longer and feels more complete." | #3 — You don't need permission |
| "What makes the bottles special?" | "Every Whiff Theory bottle is designed to feel like a keepsake. The label, finish, and presentation are all part of the experience." | #1 — The story is the point |
...
| "What do the collection names mean?" | Briefly explain the 3-tier wardrobe. Link to each collection. | #2 — Start anywhere, build your story |
...
|---|---|
| **Cart summary** | Product image (bottle and label, not generic thumbnail), product name, price, quantity. Clean, no distractions. |
| **Bundle suggestion** | "Complete the wardrobe" — one bundle recommendation based on cart contents. E.g., if buying Regular, suggest the Starter Set. Not an upsell grid — one confident recommendation. |
| **Price display** | No crossed-out prices. No "you saved ₹X." Just the price. Honest. |
| **Trust strip** | Below the cart: "Genuine fragrances · Considered presentation · Secure checkout" — 3 micro-trust signals with icons. |
...
| **Order confirmation** | Styled, branded confirmation page + email. Includes: "Your [product name] is on its way. Here's the next chapter: [one recommendation]." The wardrobe starts immediately. |
...
| **Journey stories** | "I Started with Day. Here's Where I Am Now." | #2 — Start anywhere, build your story |
...
|---|---|---|
| **Purchased nodes (●)** | Solid, glowing circles. Colored by collection tier (Day = warm ivory, Signature = antique gold, Night = deep garnet, Statement = champagne). Pulse gently on idle. On hover/tap: expand to show product name, label art thumbnail, purchase date, and note tags. | Canvas-based (HTML5 Canvas or WebGL via Three.js) or SVG with GSAP/Framer Motion animation. Each node = data point from order history. |
...
| **Empty future nodes** | Faint, drifting dots representing products not yet explored. Clustered by collection tier. They float in a soft, pale background — the "undiscovered" part of the constellation. On hover: "Something awaits here" + collection name. | Products from the catalog that the user hasn't purchased or wishlisted. Creates a visual "incompleteness" that drives curiosity. |
...
| # | Section | Content | Design Notes |
|---|---|---|---|
| **1** | **Journey Header** | "Your Scent Journey" + the customer's name. Below: a one-line summary — "3 scents discovered. 2 on your radar. Your personality: Night Owl." | Personal, warm. Not "My Account" — this is a *page about them*, not a settings page. Light background, dark text, soft accent lines. |
| **2** | **The Constellation** | Full-width animated constellation map (described above). Takes up the majority of the viewport. Interactive — nodes are tappable/hoverable. | This is the hero of the page. It should feel like looking at a personal star map on a pale canvas, with subtle luminous nodes and soft particle effects. Loads with a gentle fade-in, nodes appearing one by one in purchase-date order. |
...
| **The Minimalist** | Low complexity, low boldness. Prefers clean, crowd-friendly scents. Sticks to what works. | Repeat purchases within Day, fresh/clean notes |
| **The Provocateur** | High boldness, high complexity, low sweetness. Wants scents that start conversations. | Purchases in Night / Statement, smoky/animalic notes |
...
| State | Behavior |
|---|---|
| **First visit (no purchases)** | The constellation is all empty/future nodes drifting gently. Message: "Your story starts with your first scent. Every purchase lights up your constellation." CTA → Day. The page is a teaser — beautiful but empty, making you want to fill it. |
...
| **Collection tier position** | High | Where they are on the ladder determines *which direction* to push. Day buyers get Signature suggestions. Signature buyers get Night teasers. Nobody gets pushed backwards. |
...
|---|---|---|---|
| **"Your Next Chapter"** | Next product on the Collection Ladder based on current tier + note preference. Always pushes *forward*. | Product page (bottom), Scent Journey page (section 5), post-purchase email | *"You've explored Day. Based on your love for warm notes, Signature is your next chapter."* |
...
| Rule | Why |
|---|---|
| **Never push backwards on the ladder** | A customer who bought Signature products doesn't get Day suggestions. The journey goes forward. |
...
|---|---|---|
| **Navigation Bar** | Logo (left), collection links as journey sequence (center/horizontal), Cart icon + count (right). Light background `#FFFFFF`, warm dark text `#1C1A17`. | Sticky on scroll. On mobile: hamburger → full-screen overlay with collection journey visuals. The nav itself communicates the brand — collections displayed as a progression, not a flat list. |
| **Journey Progress Bar** | Thin horizontal bar below nav or integrated into collection pages. 4 segments: Day → Signature → Night → Statement. Current collection highlighted in Antique Gold. | Clickable navigation. Always shows where the customer "is" in the wardrobe. Subtle animation on load — the progression fills left to right. |
...
| **Collection Badge** | Micro label in ALL CAPS. "DAY" / "SIGNATURE." Background matches collection accent color. | Product cards, product page hero, cart summary. Instantly tells the customer which tier a product belongs to. |
...
| **Trust Strip** | 3-icon horizontal strip: "Genuine EDP" + "Considered Presentation" + "Secure Checkout." | Homepage, cart, checkout. Micro-reassurance at decision points. |
...
| **"Ready for More?" Block** | End-of-collection nudge. One card pointing to the next collection. "Liked Day? → Signature is where it gets more personal." | Bottom of collection pages. The wardrobe in action. |
...
| **Bundle Builder** | Pre-configured bundles: "The Starter Set" (2 Day + 1 Signature). Bundle price = value add, not discount. | P1 — Post-launch |
...
### 5A. Overall Aesthetic: Bright Gallery, Not Marketplace

The Whiff Theory storefront should feel like walking into a **bright, curated art gallery** — not browsing a marketplace. Every element serves the art. White space is generous. The products are displayed, not stacked.

| Principle | Rule | Example |
|---|---|---|
| **Bright canvas, soft contrast** | Default light backgrounds make label art pop. The product is the color — the site is the frame. | Product pages on `#FBF7F0` and `#FFFFFF` with vibrant label illustrations in the hero. |
...
| **Minimal UI** | Buttons, icons, and navigation are subtle servants. The UI should be nearly invisible — the products are the interface. | Thin borders, no heavy drop shadows, no gradients on UI elements. Champagne accent for interactive elements only. |
...
|---|---|
| **Light canvas** | Full light backgrounds. Fresh, breathable, and easy to browse. |
...
|---|---|
| **Home** | Airy. Full-bleed hero, then curated gallery scrolling. Feels like a lookbook, not a store. |
| **Collection** | Editorial. Magazine-style layout with collection identity (color, art style) carrying the page. |
| **Product** | Exhibition. The product is the exhibit. Light walls, soft spotlight on the art, narrative on a plaque beside it. |
| **About** | Documentary. Personal, warm, and brighter. Photos with natural light. "Built, not polished" lives here. |
...
| **Primary CTA (homepage)** | "Begin the Story" | "Explore the Wardrobe" |
| **Secondary CTA (collection)** | "View" (on product card hover) | "See the Art" |
| **Next step** | "Next Chapter →" | "Go Deeper →" |
...
| State | Copy |
|---|---|
| **Empty cart** | "Nothing here yet. Every story starts with one scent." → CTA: "Browse Day" |
| **Coming Soon collection** | "This chapter is still being written. Drop your email — you'll be the first to know." |
...
- [ ] Collection pages for Regular, Signature, and Bold
- [ ] Product pages with label art hero, scent profile, story behind, add-to-cart, and "Your Next Step"
- [ ] About page with brand story, values, Vizag section, premium pricing note
