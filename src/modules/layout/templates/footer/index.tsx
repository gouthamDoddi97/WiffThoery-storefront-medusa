        ...
        <FadeIn delay={0}>
          <div className="flex flex-col small:flex-row w-full pt-8 border-t border-surface-variant/30 justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              <a href="https://instagram.com/whifftheory" target="_blank" rel="noreferrer" className="text-on-surface-variant hover:text-primary transition-colors" aria-label="Instagram">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="square">
              ...
              <a href="https://twitter.com/whifftheory" target="_blank" rel="noreferrer" className="text-on-surface-variant hover:text-primary transition-colors" aria-label="X / Twitter">
